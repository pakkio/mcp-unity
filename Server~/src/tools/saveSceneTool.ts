...
const toolDescription = 'Saves the current active scene or all modified scenes. If untitled, saves automatically to Assets/Scenes/ without prompting.';
...
const paramsSchema = z.object({
  ...
  saveAllModified: z.boolean().optional().describe('If true, saves all open scenes that are dirty or untitled. Default: false')
});
...
async function toolHandler(mcpUnity: McpUnity, params: any) {
  ...
  return {
    ...
    structuredContent: {
      ...
      autoGeneratedPath: response.autoGeneratedPath,
